...
const SaladMenu = () => {
  const salads = [
    { name: "Kebabsallad", price: "125:-", ingredients: "Kebab, sallad, lök, feferoni, tomat, gurka, sås" },
    { name: "Kycklingsallad", price: "125:-", ingredients: "Kyckling, sallad, lök, feferoni, tomat, gurka, sås" },
    { name: "Räksallad", price: "125:-", ingredients: "Räkor, sallad, lök, tomat, gurka, citron, ägg, sås" },
    { name: "Tonfisksallad", price: "125:-", ingredients: "Tonfisk, sallad, lök, tomat, gurka, citron, ägg, sås" },
    { name: "Grekisk sallad", price: "125:-", ingredients: "Fetaost, oliver, sallad, lök, tomat, gurka, feferoni, sås" },
    { name: "Falafelsallad", price: "125:-", ingredients: "Falafel, sallad, lök, tomat, gurka, feferoni, sås" },
  ];
          ...
          {salads.map((salad, index) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <span className="text-[10px] uppercase font-bold text-primary tracking-widest">Inklusive bröd & sås</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="relative group rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-primary/5">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 z-20">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-primary font-bold uppercase tracking-[0.2em] text-sm">Fräschhet i varje skål</span>
            </div>
